...
func chapter2_ep03_script():
	...
	await novel_interface.show_dialog("你真的不知道吗？\nSID是元老院直属的情报机构。", GameConfig.player_name)
	await novel_interface.show_dialog("虽然有人说第五学园都市能一直保持中立，SID的功劳比『埃癸斯』的防护系统还要大……", GameConfig.player_name)
	await novel_interface.show_dialog("但更多是“某人被SID带走从此人间蒸发”的都市传说，总之是很恐怖的间谍机关。", GameConfig.player_name)
	await novel_interface.show_dialog("哦……那学园都市是什么？", "安妮")
	await novel_interface.show_dialog("（喂喂……这家伙完全没有常识吗？）", GameConfig.player_name)
	...
	await novel_interface.show_dialog("（这片商业区的地下居然有如此巨大的迷宫般的构造嘛……）", GameConfig.player_name)
	...
	await novel_interface.show_dialog("（希望我不会在这里变成“不存在”……）", GameConfig.player_name)
	...
	await novel_interface.show_dialog("呜啊——！", GameConfig.player_name)
	novel_interface.character_dark()
	await novel_interface.show_text_only("突然有人从背后用力揽住了我的腰。")
	novel_interface.character_light(0.35,"sob")
	await novel_interface.show_dialog("啊啊诶痛痛痛痛痛——！！！！！", GameConfig.player_name)
	...
	await novel_interface.show_dialog("（诶？？好、好大！！！！）", GameConfig.player_name)
	...
	await novel_interface.show_dialog("（啊！不好，顺口就叫出来了……）", GameConfig.player_name)
	...
	await novel_interface.show_dialog("噫！对、对不起！", GameConfig.player_name)
	...
	await novel_interface.show_dialog(GameConfig.player_name+"，这个姐姐好像比刚才遇到的敌人还可怕……", "安妮")
	novel_interface.character_light(0.35,"wry_smile")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("（是啊，跟她说谎马上会被看穿的样子……）", GameConfig.player_name)
	await novel_interface.hide_2nd_character()
	novel_interface.character_move_right(0,0.3,false,"sob")
	await novel_interface.show_dialog("（还是老实交代吧！啊啊啊！不管了！）", GameConfig.player_name)
	novel_interface.change_expression("worry")
	await novel_interface.show_dialog("我叫"+GameConfig.player_name+"，该从哪里说起才好呢…", GameConfig.player_name)
	await novel_interface.show_dialog("事情的经过有点复杂，我自己也很混乱。", GameConfig.player_name)
	await novel_interface.show_dialog("你听了也不一定会相信……", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","speak")
	...
	await novel_interface.show_dialog("……我……做了个梦。", GameConfig.player_name)
	novel_interface.change_expression("worry")
	await novel_interface.show_dialog("因为要完成户外教学的报告，我去研究中心听讲座\n……是在昨天闭馆之前才赶到的。", GameConfig.player_name)
	await novel_interface.show_dialog("我在那遇到了你，你说那里被人入侵了……", GameConfig.player_name)
	novel_interface.character_dark()
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("是的，的确是你。\n你还不由分说的把我拖到墙角……", GameConfig.player_name)
	novel_interface.change_expression("worry")
	await novel_interface.show_dialog("啊对了，你好像是元老院评定的SS级科学家……莉琉·冯·布劳恩博士，没错吧？", GameConfig.player_name)
	novel_interface.character_dark()
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("然后你放倒了一个劫匪并抢了一把手枪，叫我待在原地等救援，就自己去劫持现场了……", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light()
	await novel_interface.show_dialog("劫持现场？\n是什么位置？", "莉琉")
	novel_interface.character_light(0.35,"gratified")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("嗯，你说是『会议厅』。", GameConfig.player_name)
	await novel_interface.show_dialog("当时要举行一个讲座，你本应是主讲人。", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"normal2")
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("那个……莉琉小姐？", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"normal2")
	await novel_interface.show_dialog("嗯，没事，继续说。", "莉琉")
	novel_interface.character_light()
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("然后来了几个带着枪的蒙面人，我逃走时摔到了楼下，挣扎着爬到一块石板的阴影里躲了起来……", GameConfig.player_name)
	await novel_interface.show_dialog("对不起，这一段我记不太清楚了……", GameConfig.player_name)
	await novel_interface.show_dialog("然后我似乎晕过去了，醒过来的时候，就发现……", GameConfig.player_name)
	novel_interface.character_dark()
	...
	await novel_interface.show_dialog("四处都是浓烟和大火", GameConfig.player_name)
	await novel_interface.show_dialog("研究中心和周围的建筑变成了一片废墟……", GameConfig.player_name)
	await novel_interface.show_dialog("空气里有一股刺鼻的味道。", GameConfig.player_name)
	novel_interface.change_expression("upset")
	await novel_interface.show_dialog("还有厚重的咸味，让人舌根发涩……", GameConfig.player_name)
	await novel_interface.show_dialog("所有人都变成了石像", GameConfig.player_name)
	await novel_interface.show_dialog("不，不是石头，是盐。", GameConfig.player_name)
	novel_interface.change_expression("solemn")
	await novel_interface.show_dialog("我看到一个发光的东西飘在半空", GameConfig.player_name)
	await novel_interface.show_dialog("明明是那样地狱般的景象\n却能感到一种异样的宁静……", GameConfig.player_name)
	await novel_interface.show_dialog("似乎有什么在回应我……", GameConfig.player_name)
	novel_interface.change_expression("normal1")
	await novel_interface.show_dialog("然后我的记忆就模糊了，应该是有一道光——", GameConfig.player_name)
	await novel_interface.show_dialog("嗯……然后梦就到此为止了。", GameConfig.player_name)
	novel_interface.change_expression("worry")
	await novel_interface.show_dialog("等我回过神来，发现躺在自己房间的床上，时间已经是早上了。", GameConfig.player_name)
	await novel_interface.hide_character()
