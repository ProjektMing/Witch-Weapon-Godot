...
func chapter2_ep05_script():
	...
	await novel_interface.show_dialog("异变区域？是研究中心吗？", GameConfig.player_name)
	novel_interface.character_light()
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("没错。", "莉琉")
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"wry_smile")
	await novel_interface.show_dialog("会不会是机器故障什么的……我可是一直都在大路上啊。", GameConfig.player_name)
	novel_interface.character_2nd_dark()
	...
	await novel_interface.show_dialog("那个什么波动……很严重吗？", GameConfig.player_name)
	novel_interface.character_light(0.35,"normal2")
	novel_interface.character_2nd_dark()
	...
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"wry_smile")
	await novel_interface.show_dialog("你对元老们的描述真是别致……", GameConfig.player_name)
	...
	await novel_interface.show_dialog("我才不是女孩子！！", GameConfig.player_name)
	novel_interface.change_2nd_expression("shy")
	await novel_interface.show_dialog("总之我不说就是啦……", GameConfig.player_name)
	novel_interface.character_light(0.35,"normal2")
	novel_interface.character_2nd_dark()
	...
	await novel_interface.show_dialog("……会有人受伤吗？", GameConfig.player_name)
	novel_interface.character_light(0.35,"serious")
	novel_interface.character_2nd_dark()
	...
	await novel_interface.show_dialog("那这次……", GameConfig.player_name)
	novel_interface.character_light()
	novel_interface.character_2nd_dark()
	...
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"wail")
	await novel_interface.show_dialog("……明、明白了！！", GameConfig.player_name)
	await novel_interface.show_dialog("我……我绝对不会乱说啦！！", GameConfig.player_name)
