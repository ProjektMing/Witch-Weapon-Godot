...
func chapter2_ep09_script():
	...
	await novel_interface.show_dialog("哈？开什么玩笑……", GameConfig.player_name)
	...
	await novel_interface.show_dialog("对哦，『埃癸斯』系统是模因类『异质物』……", GameConfig.player_name)
	...
	await novel_interface.show_dialog("基于……灵魂？", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","normal2")
	...
	await novel_interface.show_dialog("毎个人……都是一个编号？", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","normal2")
	...
	novel_interface.show_character("ren_battle","worry")
	await novel_interface.show_dialog("怪不得你能对其他国家的情报人员进入新丰洲了如指掌。", GameConfig.player_name)
	...
	await novel_interface.show_dialog("啊？", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","normal2")
	...
	await novel_interface.show_dialog("诶——？？", GameConfig.player_name)
	await novel_interface.show_dialog("什、什么你的人啊！！！", GameConfig.player_name)
	novel_interface.character_light(0.35,"normal1")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("呵呵呵~我来看看……\n"+GameConfig.player_name+"，ID是2519G1911，15岁", "莉琉")
	await novel_interface.hide_all_characters()
	...
	novel_interface.show_character("ren_battle","panic")
	await novel_interface.show_dialog("哎？变矮了吗？", GameConfig.player_name)
	novel_interface.change_expression("sob")
	await novel_interface.show_dialog("（也对……之前的衣服都不合身了……）", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","normal2")
	...
	await novel_interface.show_dialog("就……这、这么轻易的？？", GameConfig.player_name)
	novel_interface.character_light(0.35,"normal1")
	novel_interface.character_2nd_dark()
	...
	await novel_interface.show_dialog("居然！居然就这么轻易的…！！", GameConfig.player_name)
	novel_interface.character_2nd_dark()
