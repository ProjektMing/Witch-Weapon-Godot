...
func chapter2_ep02_script():
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("欸？你以前也遇到过这样的状况？？", GameConfig.player_name)
	novel_interface.change_expression("worry")
	await novel_interface.show_dialog("（也是呢……安妮应该不是一般人吧？）", GameConfig.player_name)
	novel_interface.change_expression("wry_smile")
	await novel_interface.show_dialog("（如果是安妮的话，或许能理解我的处境……）", GameConfig.player_name)
	novel_interface.character_dark()
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("理解个头啊！！！", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"smile")
	await novel_interface.show_dialog("嗯嗯~其实"+GameConfig.player_name+"是那种会迷恋异性味道的体质吧？不用难为情的啦……", "安妮") #文本变化important
	novel_interface.character_light(0.35,"sob")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("不要做出一幅“虽然你是变态但我会包容你”的表情啊！！！", GameConfig.player_name)
	novel_interface.change_expression("wry_smile")
	await novel_interface.show_dialog("唉……我为什么会变成这样还是完全没有头绪……", GameConfig.player_name)
	novel_interface.character_dark()
	...
	await novel_interface.hide_character()
	novel_interface.show_character("ren_battle","panic")
	await novel_interface.show_dialog("我是本市的学生……", GameConfig.player_name)
	novel_interface.change_expression("wail")
	await novel_interface.show_dialog("我们只、只是来做校外教学参观了一下研究所……", GameConfig.player_name)
	await novel_interface.hide_character()
	...
	novel_interface.character_move_left(-0.25,0.3,false)
	novel_interface.show_2nd_character("anne_battle","worry",0.25)
	await novel_interface.show_dialog(GameConfig.player_name+"，这些家伙看起来很不妙呢…\n不如我们看准时机逃掉吧。", "安妮")
	...
	await novel_interface.show_dialog("（超出常识的事件……吗？）", GameConfig.player_name)
	novel_interface.change_expression("normal1")
	await novel_interface.show_dialog("好，明白了，我跟你们走。", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"perspire")
	await novel_interface.show_dialog("哎？？怎么就跟着走了啊！\n喂！"+GameConfig.player_name+"！", "安妮")
	novel_interface.character_light(0.35,"awkward")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("别、别拽了！笨蛋裙子要拽掉了！", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"perspire")
	await novel_interface.show_dialog("你才是笨蛋啊！为什么要跟这么可疑的家伙走，如果被灌药卖掉了怎么办？！", "安妮")
	novel_interface.character_light(0.35,"shy_right")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("我一个大男人有什么好……", GameConfig.player_name)
	novel_interface.change_expression("wry_smile")
	await novel_interface.show_dialog("不对、谁会找来这么多人大张旗鼓的拐卖人口啊！", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"frustrate")
	await novel_interface.show_dialog(GameConfig.player_name+"一定没见过莱博娜群岛的黑帮吧……", "安妮")
	novel_interface.character_light(0.35,"panic")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("总之……说不定能搞清楚一些事呢\n还是乖乖跟她走吧……", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"worry")
	await novel_interface.show_dialog("好吧，你去哪我都会跟着你啦……", "安妮")
	novel_interface.character_light()
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("那个，方便的话能不能先给我一件外套。", GameConfig.player_name) 
	novel_interface.change_expression("shy_left")
	await novel_interface.show_dialog("这件衣服实在有点……", GameConfig.player_name)
	novel_interface.character_dark()
	...
	await novel_interface.hide_character()
	novel_interface.show_character("ren_battle","panic")
	await novel_interface.show_dialog("到底是什么样的长官啊！！", GameConfig.player_name)
