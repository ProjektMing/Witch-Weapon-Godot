...
func chapter2_ep08_script():
	...
	await novel_interface.show_dialog("怎…怎么可能？！", GameConfig.player_name)
	await novel_interface.hide_character()
	...
	await novel_interface.hide_character()
	novel_interface.show_character("ren_battle","panic")
	await novel_interface.show_dialog("这想法……会不会太大胆了些……", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","normal2")
	...
	await novel_interface.show_dialog(GameConfig.player_name+"，这一点你必须清楚，只要你还是女孩的身体，就不可能回到原来的生活。", "莉琉")
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("在我小时候妈妈就去世了\n爸爸……也已经失踪好多年……", GameConfig.player_name)
	await novel_interface.show_dialog("我在12岁之前一直住在寄宿学校。", GameConfig.player_name)
	novel_interface.character_dark()
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("身份……转换？", GameConfig.player_name)
	novel_interface.character_dark()
