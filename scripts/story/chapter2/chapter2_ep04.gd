...
func chapter2_ep04_script():
	...
	await novel_interface.show_dialog("嗯……但一切都真实得不像梦，我也有点糊涂。", GameConfig.player_name)
	novel_interface.change_expression("worry")
	await novel_interface.show_dialog("我找了好久，可完全查不到火灾或建筑损毁的新闻\n城市的景象也和平时没什么不同。", GameConfig.player_name)
	...
	await novel_interface.show_dialog("一觉醒来……", GameConfig.player_name)
	novel_interface.change_music("res://assets/audio/music/Whisky.mp3")
	await novel_interface.show_dialog("我的身体，变成女生了……", GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("liliu_uniform2","normal2")
	...
	await novel_interface.show_dialog("我……别看我现在这样……", GameConfig.player_name)
	await novel_interface.show_dialog("我！我其实，本来是男生啊！！", GameConfig.player_name)
	await novel_interface.hide_character()
	...
	await novel_interface.hide_character()
	novel_interface.show_character("ren_battle","awkward")
	await novel_interface.show_dialog("呀啊啊啊！很痒呀……！", GameConfig.player_name)
	novel_interface.change_expression("perspire1")
	await novel_interface.show_dialog("莉琉小姐！那里！不行啊！", GameConfig.player_name)
	novel_interface.change_expression("awkward")
	await novel_interface.show_dialog("不行啊啊啊啊~~~！！！！！", GameConfig.player_name)
	await novel_interface.hide_character()
	await novel_interface.show_text_only("……")
	novel_interface.show_character("ren_battle","sob")
	await novel_interface.show_dialog("呜呜呜呜………", GameConfig.player_name)
	await novel_interface.show_dialog("总、总而言之！到昨天为止我都是男生！", GameConfig.player_name)
	await novel_interface.show_dialog("也没有做过任何手术之类的……", GameConfig.player_name)
	novel_interface.character_move_left(-0.25)
	...
	await novel_interface.show_dialog("有了！哼，就是这个！\n你们看！我是男的吧？", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"normal2")
	await novel_interface.show_dialog("虽然五官的排列倒确实有一点点像，但仅凭这种东西……", "莉琉")
	await novel_interface.show_dialog("对了，调出城市监控系统最近1个月拍摄到"+GameConfig.player_name+"的所有录像……", "莉琉")
	novel_interface.character_2nd_dark()
	await novel_interface.show_text_only("莉琉熟练的在平板上点按了起来，脸上露出了一丝兴奋的表情。")
	novel_interface.character_light(0.35,"worry")
	await novel_interface.show_dialog("看到那些废墟的时候我还以为自己在做梦，以为醒了就好了……", GameConfig.player_name)
	await novel_interface.show_dialog("可醒来却发现自己变成了女孩子……", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"normal1")
	...
	novel_interface.character_light(0.35,"bored")
	await novel_interface.show_dialog("难道那不是梦？可是现在一切都好好的，完全不像发生过那种事情……", GameConfig.player_name)
	novel_interface.change_expression("wry_smile")
	await novel_interface.show_dialog("啊……我真是，完全搞不清楚了……！", GameConfig.player_name)
	await novel_interface.show_dialog("到底我的记忆里哪些是真的哪些是梦啊……！", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light()
	await novel_interface.show_dialog("……步态识别模式吻合。", "莉琉")
	novel_interface.character_light(0.35,"worry")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("是什么意思？", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"normal2")
	...
	await novel_interface.show_dialog("我还以为到这里就能搞清楚点什么……", GameConfig.player_name)
	novel_interface.character_move_left(-0.25)
	novel_interface.show_2nd_character("liliu_uniform2","normal2",0.25)
	await novel_interface.show_dialog("我说，你知道什么关于『洛斯金杯』的事吗？", "莉琉")
	novel_interface.character_light(0.35,"wry_smile")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("洛斯金杯？早上看到新闻说在监控下突然消失的异质物……我也没亲眼见过啦。", GameConfig.player_name)
	novel_interface.character_dark()
	novel_interface.character_2nd_light(0.35,"normal1")
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("对了，后来我爬出废墟，看到飞在天上的发光的东西轮廓确实有点像个杯子……", GameConfig.player_name)
	novel_interface.change_expression("normal1")
	await novel_interface.show_dialog("就那么浮在半空，发出的光还泛着淡淡的红色……", GameConfig.player_name)
	await novel_interface.hide_character()
