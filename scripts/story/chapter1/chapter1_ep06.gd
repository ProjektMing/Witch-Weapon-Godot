...
func chapter1_ep6_script():
	...
	await novel_interface.show_dialog("你、你到底是什么人！？\n从哪里冒出来的！？",GameConfig.player_name)
	await novel_interface.show_dialog("袭击我的那些家伙是什么东西！？\n这根球棒又是啥！？",GameConfig.player_name)
	await novel_interface.show_dialog("这里怎么了？！",GameConfig.player_name)
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("抱歉。我太慌乱了……",GameConfig.player_name)
	novel_interface.character_dark()
	...
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("……我叫"+GameConfig.player_name+"，请多关照。",GameConfig.player_name)
	novel_interface.character_dark()
	...
	novel_interface.character_light(0.35,"normal1")
	novel_interface.character_2nd_dark()
	await novel_interface.show_dialog("……战服？",GameConfig.player_name)
	...
	await novel_interface.show_dialog("而且胸口传来的紧缚感不会是……（摸）",GameConfig.player_name)
